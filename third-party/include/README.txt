This directory holds precompiled third-party library header files used to
build GoldenDict under Windows or Mac OS X. Those are supplied merely
to ease the build process. No other platform except Windows or Mac OS X
uses those files, so they can safely be removed for Linux builds etc.
