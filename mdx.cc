...
bool MdxDictionary::ensureInitDone(std::string *err)
{
    doDeferredInit();
    if(initError.empty())
        return true;
...
void MdxDictionary::makeFTSIndex( AtomicInt32 & isCancelled, bool firstIteration )
{
