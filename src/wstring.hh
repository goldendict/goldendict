...
/// ancient history dating back to when there was nothing by a BLP, and
...
/// benefit of ISO-8859-1 compatibility, having a much more useless BLP
...
/// use QString, and second, use basic_string< uint32_t >.
...
/// it to use basic_string< uint32_t > instead, since it shares the same
/// template, and therefore the interface too, with wstring.
